...
You pick up the marble chess set. You can scry it to learn its properties.

*[Scry]
~playScrySound = 1

-This game is luxury defined. This is a serious set for serious players, the type who will win in five moves against most foes.

<b>vessel:</b> chess set (toy)

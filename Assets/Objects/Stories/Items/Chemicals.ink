...
=== start
{
-murderWeapon == "jar of chemicals":
~playerFoundWeapon = 1
As you pick up the container, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have. 
It's a bottle of chemicals used in the development process. But you take a sniff and cough. This isn't just thiosulfates for fixing film. Your nose knows the scent of arsenic. 
-> success

-else:
It's a bottle of chemicals used in the development process. You take a sniff, and are satisfied that it's just thiosulfates for fixing film.
*[Continue searching]
~storyEnd = 1
-> END
}

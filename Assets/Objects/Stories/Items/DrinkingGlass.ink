...
=== start
{
-murderWeapon == "drinking glass":
~playerFoundWeapon = 1
As you pick up the glass, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have.
You pick it up, and the smell makes you grimace. The water has been laced with rat poison. This must be how the victim succumbed.
-> success

-else:
And no wonder. The house is stuffy, the air thick. Choking. But the glass and its contents seem harmless.
*[Continue searching]
~storyEnd = 1
-> END
}

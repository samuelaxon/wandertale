...
=== start
{
-murderWeapon == "perfume bottle":
~playerFoundWeapon = 1
As you pick up the bottle, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have.
The bottle is made of thin glass, too delicate to inflict serious damage. You pick up the nearly empty vessel and take a cautious sniff of the remaining contents. Rather than roses or a Chanel fragrance, your nose immediately detects a different flower. A nightshade. A deadly nightshade.
-> success

-else:
The bottle is made of thin glass, too delicate to inflict serious damage. You pick up the nearly empty vessel and take a cautious sniff of the remaining contents. It smells like pressed rose petals, the sickly sweet smell of floral decay. Not pleasant, but definitely not deadly.
*[Continue searching]
~storyEnd = 1
-> END
}

...
=== start
{
-murderWeapon == "camera tripod":
~playerFoundWeapon = 1
As you pick up the stand, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have. 
One of the tripod's three legs is bent. You notice a few drops of blood crusting the bowed legs. This was clearly used to inflict blunt trauma that must have been lethal.
-> success

-else: 
A tripod is probably a common sight in the home of an acclaimed director. You give it a closer look, but nothing about the device seems unusual.
*[Continue searching]
~storyEnd = 1
-> END
}

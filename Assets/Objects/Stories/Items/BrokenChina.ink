...
=== start
{
-murderWeapon == "broken china":
~playerFoundWeapon = 1
As you pick up the pieces, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have. 
No windows are open, so wind couldn't have knocked the dish over. You crouch down for a closer look. One of the shards is stained scarlet. Blood.
-> success

-else:
No windows are open, so wind couldn't have knocked the dish over. How odd. But nothing else in the room seems amiss. These shards must have been accidental, not lethal.
*[Continue searching]
~storyEnd = 1
-> END
}

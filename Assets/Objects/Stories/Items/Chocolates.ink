...
=== start
{
-murderWeapon == "box of chocolates":
~playerFoundWeapon = 1
As you pick up the sweets, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have.
It's an assortment of truffles, imported from Paris. But more than the rich scent of sugar, your nose picks up on harsher chemicals. Someone has doused these treats in rat poison, and you're sure the victim is the one who paid the price.
-> success

-else:
It's an assortment of truffles, imported from Paris. But the heady scent of sugar isn't enough to distract you from your work.
*[Continue searching]
~storyEnd = 1
-> END
}

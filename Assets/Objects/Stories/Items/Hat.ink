...
-murderWeapon == "hat":
~playerFoundWeapon = 1
As you pick up the hat, all the hairs on your arms stand up. You've been trained in observation and analysis, but there's no protocol from headquarters for the prickling feeling you have. 
You pick up the item that someone has carelessly dropped. It's a blue hat, covered with feathers and flowers. As you turn it over, you see rusty stains on the fabric. The hat pin is crusted with blood. It must have been used as a very stylish stiletto on the victim.
-> success

-else:
You pick up the item that someone has carelessly dropped. It's a blue hat, covered with feathers and flowers. Someone in this house has a flair for dramatic fashion.
*[Continue searching]
~storyEnd = 1
-> END
}

...
-hidingSpot == "bathtub":
~playerFoundBody = 1
You peer into the tub. {weaponType == 0:The porcelain is smeared with blood}{weaponType == 1:The porcelain is smeared with vomit} from the crumpled form of {victim}'s body.
...
-else:
You peer into the tub, and heave a sigh of relief to find it empty.
*[Continue searching]
~storyEnd = 1
-> END
}

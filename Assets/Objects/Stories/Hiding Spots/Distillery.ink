...
-hidingSpot == "barrels":
~playerFoundBody = 1
You carefully shift every barrel in the stack. Each one sloshes with liquid. No bodies inside them. But as you continue your check, you find your unhappy target. {victim}'s dead body has been pushed behind the barrels.
...
-else:
You carefully shift every barrel in the stack. Each one sloshes with liquid. No bodies inside them and none hidden behind the pile.
*[Continue searching]
~storyEnd = 1
-> END
}

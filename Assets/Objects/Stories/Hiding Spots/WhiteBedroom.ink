...
-hidingSpot == "armoire":
~playerFoundBody = 1
You pull open the doors, holding your breath. The body of {victim} tumbles out at your feet, stiff and cold.
...
-else:
You pull open the doors, holding your breath. All you see is a rack of dresses in shades of brown and navy.
*[Continue searching]
~storyEnd = 1
-> END
}

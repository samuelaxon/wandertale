...
=== start
{
-hidingSpot == "bedsheets":
~playerFoundBody = 1
You pull the quilts and blankets off the bed. Underneath the layers of {weaponType == 0:bloody} bedding, you find {victim}. Deceased. 
...
-else:
You pull the quilts and blankets off the bed. It is a lot of bedding for the warm Los Angeles climate, but you don't find anything peculiar.
*[Continue searching]
~storyEnd = 1
-> END
}

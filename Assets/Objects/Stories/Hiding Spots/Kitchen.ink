...
-hidingSpot == "icebox":
~playerFoundBody = 1
You swing open one of the icebox doors. Rather than food, you find the body of {victim}.
...
-else:
You swing open one of the icebox doors, but bottles of cold milk and food are all that greet you.
*[Continue searching]
~storyEnd = 1
-> END
}

...
-hidingSpot == "trunk":
~playerFoundBody = 1
The trunk is surrounded by more piles of film reels. You click open the latches and lift the lid with a sinking feeling. Inside is {victim}.
...
-else:
You click open the latches on the trunk and lift the lid. Inside you find more reels and more mess, but nothing related to the murder.
*[Continue searching]
~storyEnd = 1
-> END
}

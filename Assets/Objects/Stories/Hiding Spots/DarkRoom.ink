...
-hidingSpot == "canvas": 
~playerFoundBody = 1
And they are. {weaponType == 0:As you pull aside a piece of black canvas, you see a trickle of blood leading to {victim}'s body slumped in the corner.}{weaponType == 1:As you turn, you're met with {victim}'s body slumped in the corner, stilled by poison.}.
...
-else:
It's an unpleasant place to be, so you quickly carry on with your work. No body is hidden in the corners or under the heavy canvas sheets used to protect the delicate film.
*[Continue searching]
~storyEnd = 1
-> END
}

...
-hidingSpot == "sofa":
~playerFoundBody = 1
You kneel on the floor. Before you even lift the blanket, you see the stiff legs of a corpse under the sofa. You've found {victim}, and {victimGender == 0:she|he} has definitely been murdered.
...
-else:
You kneel on the floor and lift the blanket. You peer underneath the sofa, but there's nothing here. Not even a dust bunny.
*[Continue searching]
~storyEnd = 1
-> END
}

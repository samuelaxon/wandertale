...
-hidingSpot == "curtains":
~playerFoundBody = 1
You pull back the heavy velvet fabric. You'd expected to only see the wall and the wooden planks of the windowsill, but the grayed, unseeing face of {victim} stares up at you.
...
-else:
You pull back the heavy velvet fabric. All that appears is the wall and the wooden planks of the windowsill.
*[Continue searching]
~storyEnd = 1
-> END
}

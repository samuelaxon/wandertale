...
=== start
{
-hidingSpot == "projection room":
~playerFoundBody = 1
You steel yourself and throw open the door to the projection booth. As you feared, you've found {victim}.
...
-else:
You steel yourself and throw open the door to the projection booth. Empty. Your search continues.
*[Continue searching]
~storyEnd = 1
-> END
}
